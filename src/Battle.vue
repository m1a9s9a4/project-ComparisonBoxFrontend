...
export default {
  ...
  methods: {
    getBattleId: function () {
      Axios
        .get(process.env.VUE_APP_API_URL + "/api/v1/battle/" +this.player1.id+"/"+this.player2.id)
        .then(res => {
    ...
    getQuestion: function () {
      Axios
        .get(process.env.VUE_APP_API_URL + "/api/v1/questions/type/"+this.player1.type_id)
        .then(res => {
    ...
    getPlayer: function (english) {
      Axios
      .get(process.env.VUE_APP_API_URL + "/api/v1/player/english/" + english)
      .then(res => {
    ...
    saveAnswer: function (id) {
      ...
      Axios
        .post(process.env.VUE_APP_API_URL + "/api/v1/answer", params, {
          headers: {
    ...
    _checkAnsweredQuestions: function() {
      Axios
        .get(process.env.VUE_APP_API_URL + "/api/v1/answer/users", {
          params: {
            uid: this.uid,
            bid: this.battleId,
          }
    ...
    _saveUser: function (qid) {
      ...
      Axios
        .post(process.env.VUE_APP_API_URL + "/api/v1/answer/user", params, {
          headers: {
            'Content-Type': 'application/json',
          }
        })
